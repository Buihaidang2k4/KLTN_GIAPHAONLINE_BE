...
public interface CeremonyTimelineService {
    CeremonyTimelineRes createCeremonyTimeline(Long ceremonyId, CeremonyTimelineReq req);
    ...
    CeremonyTimelineRes updateCeremonyTimeline(Long timelineId, CeremonyTimelineReq req);
